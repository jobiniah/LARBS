...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/jobiniah/dotfiles.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/jobiniah/LARBS/master/progs.csv"
